...
<template>
  <div class="dj_radio-page">
    ...
    <div>
      ...
      <BroweList title="创作翻唱" :list="data.createdAndCoverRadios"></BroweList>
...
import { reqDjCategories, reqDjRankList, reqDjRecommends,reqDjHotList } from "../api";
import { DjCategoryType, RankListType, programType,DjRadioType } from "../types/types";
...
const getDjBrowseList=async (id:2|6|3|2001|11):Promise<void>=>{
  type indexType=typeof data.value
  let index:indexType=id===2?'musicRecommendRadios':id===6?'liveRadios':id===3?'feelRadios':id===2001?'createdAndCoverRadios':'knowledgeRadios'
